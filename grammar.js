...
module.exports = grammar({
  ...
  conflicts: ($) => [
    ...
    [$.value_qid, $.record_base_identifier],
  ],
  ...
  rules: {
    ...
    _lower_case_identifier_without_leading_whitespace: ($) =>
      token.immediate(/(_[_\d\p{L}]+|\p{Ll}[_\d\p{L}]*)/),
    ...
    _record_base: ($) =>
      seq(field("baseRecord", choice($.record_base_identifier, $.field_access_expr, $.value_expr, $.parenthesized_expr)), "|"),
    ...
    record_pattern: ($) =>
      seq("{", commaSep1(field("patternList", $.record_pattern_field), ","), "}"),
